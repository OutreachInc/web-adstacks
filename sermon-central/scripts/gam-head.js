...
eventer(messageEvent, function(e) {
    ...
    if("adContentAvailable" == (i.message || "ignore") && ("sc-interstitial" == i.adUnit || "interstitial" == i.adUnit)){
        document.querySelector('[data-container-ad-unit-id="' + i.adUnit + '"]').innerHTML = i.content;
...
function canFireInterstitial(){
    return !interstitialFired && (window.pageYOffset / document.body.offsetHeight) >= (1/5) && window.innerWidth > 768
}
